...
**GitHub:** [prasanthachereddy](https://github.com/prasanthachereddy) | **Stack:** Apache Airflow | AWS S3 | AWS Glue | AWS Athena | Python | PySpark | Docker
...
| customers | 14,285 | Indian locale — names, cities, phone numbers (Faker en\_IN) |
| orders | 50,000 | Linked to customers, weighted status distribution (70% completed) |
| order\_items | 100,000 | Core fact table — ~3% intentional dirty data injected |

### Dirty Data Injected (for Glue cleaning demo)

* **Invalid FK** — product\_id 9999 does not exist in products table
...
| Data Generation | Python, Faker (en\_IN locale), Pandas |
...
[![Airflow DAG Green](https://github.com/prasanthachereddy/ecommerce-etl-pipeline/raw/main/docs/screenshots/01_airflow_dag_green.png)](/prasanthachereddy/ecommerce-etl-pipeline/blob/main/docs/screenshots/01_airflow_dag_green.png)

### Glue ETL Job Succeeded

[![Glue Job Success](https://github.com/prasanthachereddy/ecommerce-etl-pipeline/raw/main/docs/screenshots/07_glue_job_success.png)](/prasanthachereddy/ecommerce-etl-pipeline/blob/main/docs/screenshots/07_glue_job_success.png)

### Athena Analytics Result

[![Athena Result](https://github.com/prasanthachereddy/ecommerce-etl-pipeline/raw/main/docs/screenshots/08_athena_result.png)](/prasanthachereddy/ecommerce-etl-pipeline/blob/main/docs/screenshots/08_athena_result.png)

### S3 Raw Data Zone

[![S3 Raw Folder](https://github.com/prasanthachereddy/ecommerce-etl-pipeline/raw/main/docs/screenshots/03_s3_raw_folder.png)](/prasanthachereddy/ecommerce-etl-pipeline/blob/main/docs/screenshots/03_s3_raw_folder.png)
...
1. Find **ecommerce\_datagen\_etl\_pipeline** in the DAGs list
...
| Decision | Reason |
| --- | --- |
| Faker with en\_IN locale | Realistic Indian market data — names, cities, phone numbers |
...
| created\_at on every table | Enables future incremental load via watermark |
...
| max\_active\_runs=1 | Prevents S3 collisions from concurrent runs |
